...
export default function Sidebar({ isOpen, onClose, onToggle }: SidebarProps) {
  return (
    <>
      ...
      {isOpen && (
        <>
          ...
          <div className="fixed inset-x-4 top-20 z-50 md:hidden">
            <div className="bg-white rounded-2xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-top-4 duration-200">
              {/* Header */}
              ...
              <nav className="p-4 space-y-1">
                ...
                <a
                  href="#"
                  onClick={onClose}
                  className="flex items-center gap-3 px-4 py-3 text-sm font-medium bg-indigo-50 text-indigo-600 rounded-xl"
                >
      ...
      {/* Desktop Sidebar */}
      <aside
        className={`hidden md:flex md:relative bg-white border-r border-gray-200 flex-col transition-all duration-300 ease-in-out h-screen ${
          isOpen ? 'w-64' : 'w-16'
        }`}
      >
        {/* Top - Logo */}
