...
export default function Column({ column, tasks, deleteTask, onAddTask, onEditTask, onDeleteColumn }: ColumnProps) {
  ...
  return (
    <div className="w-full md:w-[350px] h-full flex flex-col bg-gray-200/60 rounded-xl max-h-full">
      {/* Header */}
      <div className="bg-white border border-gray-200 rounded-t-xl p-3 md:p-4 font-bold flex items-center justify-between flex-shrink-0">
